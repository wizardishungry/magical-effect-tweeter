...
class Magic extends Base
{
    public function __construct()
    {
        ...
        $aItemWords[$iCounter]="you become physically weaker";
        $aItemCodes[$iCounter++]=128;
        $aItemWords[$iCounter]="you become a hermaphrodite";
        $aItemCodes[$iCounter++]=128;
        $aItemWords[$iCounter]="you turn into the opposite gender";
        $aItemCodes[$iCounter++]=128;
        $aItemWords[$iCounter]="you become more fleetfooted";
        $aItemCodes[$iCounter++]=128;
        $aItemWords[$iCounter]="you become gluten-intolerant";
        $aItemCodes[$iCounter++]=128;
        $aItemWords[$iCounter]="you become lactose-intolerant";
        $aItemCodes[$iCounter++]=128;
        ...
        $aItemCodes[$iCounter++]=256;
        $aItemWords[$iCounter]="burst into song";
        $aItemCodes[$iCounter++]=256;
        ...
        $aItemCodes[$iCounter++]=256;
        $aItemWords[$iCounter]="grow mushrooms all over them";
        $aItemCodes[$iCounter++]=256;
        ...
        $aItemCodes[$iCounter++]=256;
        $aItemWords[$iCounter]="become equine";
        $aItemCodes[$iCounter++]=256;
        $aItemWords[$iCounter]="become porcine";
        $aItemCodes[$iCounter++]=256;
        $aItemWords[$iCounter]="become insectoid";
        $aItemCodes[$iCounter++]=256;
        $aItemWords[$iCounter]="become fungoid";
        $aItemCodes[$iCounter++]=256;
        $aItemWords[$iCounter]="become xyloid";
        $aItemCodes[$iCounter++]=256;
        $aItemWords[$iCounter]="become ameboid";
        $aItemCodes[$iCounter++]=256;
        $aItemWords[$iCounter]="become anthropoid";
        $aItemCodes[$iCounter++]=256;
